...
1. Compare the ATP-PCr, glycolytic, and oxidative energy systems in terms of peak power output, maximum duration, and ATP yield per glucose. Why is there an inverse relationship between power and capacity?
2. Write and explain the creatine kinase reaction that regenerates ATP from PCr. Why can this system only sustain maximal effort for 5–10 seconds, and how long does complete PCr resynthesis take during recovery?
3. Anaerobic glycolysis yields only 2–3 ATP per glucose, yet it is essential for high-intensity exercise. Explain why NAD⁺ regeneration — not ATP yield — is the critical bottleneck that lactate formation solves.
4. According to Lehninger, glucose has four major metabolic fates: storage, structural polymers, glycolysis, and the pentose phosphate pathway. For each fate, give one example relevant to exercising muscle.
5. Describe the three possible fates of pyruvate (aerobic oxidation, lactic acid fermentation, ethanol fermentation). Which fate dominates in exercising skeletal muscle above the anaerobic threshold, and why?
6. The Pasteur effect describes increased glycolysis under anaerobic conditions; the Warburg effect describes aerobic glycolysis. Explain both effects and give one physiological scenario in sport where aerobic glycolysis is advantageous.
7. Describe the Cori cycle: where does it occur, what substrate does it use, and what is its physiological role during prolonged exercise? At what exercise intensity does gluconeogenesis become quantitatively significant?
8. At what exercise intensity (% V̇O₂max) do epinephrine and norepinephrine rise significantly? Describe their downstream effects on glycogenolysis, lipolysis, and immune cell mobilization.
9. How does the insulin-to-glucagon ratio change during exercise, and what metabolic consequences does this have for hepatic glucose output and muscle substrate delivery?
10. Describe the cell-cell lactate shuttle: which cells produce lactate (MCT4-expressing), which consume it (MCT1-expressing), and what is the concentration gradient that drives transport? Why is this shuttle important for understanding fatigue?
11. The GPR81 receptor responds to extracellular lactate. What intracellular signalling cascade does this activate, and what are the downstream effects on lipolysis and adipose tissue metabolism?
12. What is histone lactylation, and how does it connect intracellular lactate accumulation to gene expression changes? Name one gene programme that lactylation is thought to regulate.
13. Compare slow-twitch (Type I) and fast-twitch (Type II) muscle fibers on four parameters: mitochondrial density, fatigue resistance, predominant energy system, and recruitment threshold. Which fiber type predominates in endurance-trained athletes?
14. Describe how AMPK is activated by exercise (AMP/ATP ratio rise, Ca²⁺ signalling). What are AMPK's key downstream targets related to: (a) glucose uptake, (b) fat oxidation, and (c) mitochondrial biogenesis?
15. Explain the mTOR pathway in the context of resistance exercise. What upstream signals activate mTORC1, and why is the anabolic window post-exercise important for timing protein intake?
16. What environmental signals activate PGC-1α (ROS, AMP/ATP, Ca²⁺), and what downstream processes does it orchestrate? How does endurance training alter PGC-1α expression over time?
17. ROS are produced continuously during exercise. At low concentrations they act as beneficial signalling molecules (Nrf2, PGC-1α activation); at high concentrations they cause cellular damage. Where is the tipping point, and how does training shift it?
18. Define EPOC (excess post-exercise oxygen consumption) and list three metabolic processes it supports. Why is the fast EPOC component larger after high-intensity than low-intensity exercise?
19. Describe the two phases of post-exercise glycogen resynthesis (rapid insulin-independent and slower insulin-dependent). What is the recommended carbohydrate intake window, and what enzyme is rate-limiting?
20. Choose one chronic disease (type 2 diabetes, metabolic syndrome, or cardiovascular disease) and construct a mechanistic argument — using AMPK, PGC-1α, and GLUT4 translocation — for why regular aerobic exercise is a first-line intervention.
