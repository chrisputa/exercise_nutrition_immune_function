...
20. For a healthy recreational runner and a patient with Long COVID, how would you use the homeostasis–hormesis table (Table 1) to justify different exercise prescriptions? Which framework is most relevant for each, and why?
